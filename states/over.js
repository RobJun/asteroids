class OverState extends State {
    constructor(SM){
        ...
        var statGroup = new RenderGroup(state, [ new GameText(state,"0", new vec2(-0.45, 0.3),{font : "Orbitron", size : "20px", color : "black", align : "left"}),
                                                 new GameText(state,"100,00%", new vec2(-0.45,0.12), {font : "Orbitron", size : "20px", color : "black",align : "left"}),
                                                 new GameText(state,"99999", new vec2(-0.45,-0.05),{font : "Orbitron", size : "20px", color : "black",align : "left"})
                                                ])
        this.objects =[
            new GameImage(state,SM.resourceMan.images.get("background"),new vec2(0,0),new vec2(0,0),AREA.width,AREA.height,800,600),
